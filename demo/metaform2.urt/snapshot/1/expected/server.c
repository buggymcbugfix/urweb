#include "include/urweb/config.h"
  ...
  static uw_unit
   ...
   return(((uw_write(ctx, "<body"), 0),
           (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onload(ctx,
            ...
            uw_end_region(ctx), (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onunload(ctx,
                                                                       "")), 0),
                                 uw_end_region(ctx), (uw_write(ctx, ">\n<ul>\n<li> <a href=\"/Metaform2/diversion\">See something shiny!</a></li>\n<li> <a href=\"/Metaform2/MM/main\">Fill out a form!</a></li>\n</ul>\n</body>"), 0)))));
   }
 ...
 if (!strncmp(request, "/Metaform2/main", 15) && (request[15] == 0 || request[15] == '/')) {
  ...
  if (!strncmp(request, "/Metaform2/MM/main", 18) && (request[18] == 0 || request[18] == '/')) {
   request += 18;
   if (*request == '/') ++request;
   uw_write_header(ctx, "Content-type: text/html; charset=utf-8\r\n");
    uw_write(ctx, uw_begin_html5);
    ...
    uw_Basis_string uw_input_X;
     ...
     request = uw_get_input(ctx, 0);
      ...
      request = uw_get_input(ctx, 1);
       if (request == NULL)
       uw_error(ctx, FATAL, "Missing input Y");
       uw_input_Y = uw_Basis_unurlifyString_fromClient(ctx, &request);
