             ...
             ({struct __uws_2 __uwr_fs_2 = (*disc);
                ((uw_write(ctx, "<body"), 0),
                 (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onload(ctx,
                  ...
                  uw_end_region(ctx), (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onunload(ctx,
                                                                             "")), 0),
                                       uw_end_region(ctx), ((uw_write(ctx, "><form method=\"post\" action=\"/Crud2/save/"), 0),
                                                            (uw_begin_region(ctx),
                                                              uw_Basis_urlifyInt_w(ctx,
                                                               __uwr_x0_0),
                                                             uw_end_region(ctx),
                                   ...
                                   uw_Basis_string arg1 =
                                    ...
                                    uw_Basis_bool arg2 =
                                     ({
                                      ...
                                      !strcmp(disc, "Ready") ? uw_Basis_True
                                        :
                                       !strcmp(disc, "Not ready") ?
                                        uw_Basis_False
                                         :
                                        1 ?
                                         ({uw_Basis_string __uwr___3 = disc;
                                            ({
                                             uw_Basis_bool
                                             tmp;
   ...
   uw_login(ctx);
   {
    uw_Basis_string uw_input_Name;
     ...
     request = uw_get_input(ctx, 0);
      ...
      uw_input_Name = uw_Basis_unurlifyString_fromClient(ctx, &request);
      request = uw_get_input(ctx, 1);
       if (request == NULL)
       uw_error(ctx, FATAL, "Missing input Ready");
       uw_input_Ready = uw_Basis_unurlifyString_fromClient(ctx, &request);
