database dbname=test
 ...
 structure Crud2 =
  struct
   table t : [#Id = int, #Name = string, #Ready = bool] keys
    ...
    structure anon =
     Crud.Make(struct
                val tab = t
                 ...
                 val cols =
                  {Name = Crud.string "Name", 
                    Ready =
                     {Name = "Ready", 
                       Show =
                        fn b =>
                         case b of
                          Basis.True => Basis.cdata "Ready!" | 
                           Basis.False => Basis.cdata "Not ready", 
                       Widget =
                        fn nm :: Name =>
                         Basis.join (Basis.cdata "\n")
                          (Basis.join
                              ...
                              (Basis.tag Basis.null Basis.None Basis.noStyle
                                ...
                                (Basis.join (Basis.cdata "\n")
                                  (Basis.join
                                    ...
                                    (Basis.join
                                      (Basis.tag Basis.null Basis.None
                                        Basis.noStyle Basis.None {} (option {})
                                        (Basis.cdata "Ready"))
                                      (Basis.join (Basis.cdata "\n")
                                        (Basis.join
                                          (Basis.cdata
                        ...
                        fn s =>
                         case s of
                          "Ready" => True | "Not ready" => False | 
                           _ => error (Basis.cdata "Invalid ready/not ready"), 
                       Inject = _}}
                end)
    open anon
   end
