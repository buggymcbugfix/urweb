#include "include/urweb/config.h"
 ...
 /* No global setup for LRU cache. */
  ...
  static uw_unit __uwn_initializer_1686(uw_context ctx, uw_unit __uwr___0)
   {
   return(0);
   }
  
  static uw_unit
   __uwn_expunger_1685(uw_context ctx, uw_Basis_client __uwr_cli_0)
   {
   return(0);
   }
  ...
  static uw_unit
   __uwn_main_1687(uw_context ctx, uw_unit __uwr_$x_0, uw_unit __uwr___1)
   {
  ...
  static uw_unit
   __uwn_wrap_ins_1684(uw_context ctx, struct __uws_3 __uwr_x0_0, 
                        uw_unit __uwr___1)
   {
   return(({
           uw_unit __uwr___2 =
  ...
  if (!strncmp(request, "/View/ins", 9) && (request[9] == 0 || request[9] == '/')) {
   ...
   uw_login(ctx);
   {
    uw_Basis_string uw_input_A;
     ...
     __uwn_wrap_ins_1684(ctx, uw_inputs, 0);
    uw_write(ctx, "</html>");
     return;
    }
    }
