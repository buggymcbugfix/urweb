#include "include/urweb/config.h"
 ...
 /* No global setup for LRU cache. */
  ...
  static uw_unit
   __uwn_wrap_handler_1687(uw_context ctx, struct __uws_1 __uwr_x0_0, 
                            uw_unit __uwr___1)
   {
  ...
  static uw_unit
   __uwn_wrap_main_1686(uw_context ctx, uw_unit __uwr_x0_0, uw_unit __uwr___1)
   {
   return(((uw_write(ctx, "<body"), 0),
           (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onload(ctx,
                                                  uw_Basis_get_settings(ctx, 0))), 0),
            uw_end_region(ctx), (uw_begin_region(ctx), (uw_write(ctx, uw_Basis_maybe_onunload(ctx,
                                                                       "")), 0),
                                 uw_end_region(ctx), (uw_write(ctx, ">\n<form method=\"post\" action=\"/Metaform1/handler\">\n<p> Tic: <input type=\"text\" name=\"A\" /></p>\n<p> Tac: <input type=\"text\" name=\"B\" /></p>\n<p> Toe: <input type=\"text\" name=\"C\" /></p>\n<input type=\"submit\" />\n</form>\n</body>"), 0)))));
   }
 ...
 if (!strncmp(request, "/Metaform1/main", 15) && (request[15] == 0 || request[15] == '/')) {
  ...
  uw_login(ctx);
  {
   uw_unit arg0 = uw_Basis_unurlifyUnit(ctx, &request);
    __uwn_wrap_main_1686(ctx, arg0, 0);
   uw_write(ctx, "</html>");
    return;
   }
   }
  ...
  if (!strncmp(request, "/Metaform1/handler", 18) && (request[18] == 0 || request[18] == '/')) {
   ...
   uw_login(ctx);
   {
    uw_Basis_string uw_input_A;
     ...
     __uwn_wrap_handler_1687(ctx, uw_inputs, 0);
    uw_write(ctx, "</html>");
     return;
    }
    }
