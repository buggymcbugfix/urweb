...
val stringToTimef : (* format *) string -> string -> option time
val stringToTimef_error : (* format *) string -> string -> time
...
con ctext = fn (more :: {Type}) => [ctextAttrs ~ more] => cformTag (ctextAttrs ++ more) []
